  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden font-sans">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/pancard-bg.jpg')" }}
      >
            ...
            {step === 3 && (
              ...
              >
                ...
                <input
                  type="file"
                  multiple
                  onChange={(e) => updateField("idProof", e.target.files)}
            ...
            {step === 5 && (
              ...
              >
                ...
                <div className="border border-gray-200 rounded-xl p-6 bg-gray-50 shadow-sm max-h-[360px] overflow-auto text-left space-y-6">
                  ...
                  <div>
                    <h3 className="text-indigo-800 font-semibold mb-1">Father's Name</h3>
                  ...
                  <div>
                    <h3 className="text-indigo-800 font-semibold mb-1">Address</h3>
                    <p className="whitespace-pre-wrap text-gray-700">{formData.address || "-"}</p>
                  </div>
                  <div>
                    <h3 className="text-indigo-800 font-semibold mb-1">City</h3>
                    <p className="text-gray-700">{formData.city || "-"}</p>
                  </div>
                  <div>
                    <h3 className="text-indigo-800 font-semibold mb-1">State</h3>
                    <p className="text-gray-700">{formData.state || "-"}</p>
                  </div>
                  <div>
                    <h3 className="text-indigo-800 font-semibold mb-1">Uploaded ID Proofs</h3>
                    {formData.idProof.length > 0 ? (
